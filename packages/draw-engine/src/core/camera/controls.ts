...
import { type Camera, MAX_ZOOM, MIN_ZOOM, type WorldBounds, screenToWorld } from "./transform";
...
/** Set an absolute zoom while keeping the world point under (sx, sy) fixed. */
