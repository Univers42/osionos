...
## Context and Role
Act as a **Senior Backend Developer specializing in TypeScript and CI** within the `osionos` project.
...
- **Goal:** Implement a robust CI workflow that includes automated testing, linting, and type checking to ensure code quality and provide faster feedback to developers.
