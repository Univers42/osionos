...
import { tableCellEditingScenarios } from "../../browser/specs/tableCellEditing.mjs";
import {
...
const { parallelScenarios, serialScenarios } = groupBrowserScenarios(tableCellEditingScenarios);
...
test.describe("table-cell-editing (serial)", () => {
