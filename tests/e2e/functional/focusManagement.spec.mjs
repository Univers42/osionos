...
import { focusManagementScenarios } from "../../browser/specs/focusManagement.mjs";
import {
...
const { parallelScenarios, serialScenarios } = groupBrowserScenarios(focusManagementScenarios);
...
test.describe("focus-management (serial)", () => {
