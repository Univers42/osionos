...
- Name: persistence/localPersistence.spec.mjs >> local-persistence >> 29. Local persistence / Seeded offline pages :: edits on an offline seeded page survive refresh and remain editable afterwards
