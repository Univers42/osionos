        ...
        <form className="mt-5 flex flex-col gap-3" onSubmit={submit}>
          {mode === "signup" && (
            <label className="flex flex-col gap-1 text-sm">
              ...
              <input
                type="text" value={name} onChange={(e) => setName(e.currentTarget.value)}
          ...
          <label className="flex flex-col gap-1 text-sm">
            ...
            <input
              type="email" required value={email} onChange={(e) => setEmail(e.currentTarget.value)}
          ...
          <label className="flex flex-col gap-1 text-sm">
            ...
            <input
              type="password" required value={password} onChange={(e) => setPassword(e.currentTarget.value)}
